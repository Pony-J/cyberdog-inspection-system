...
options = {
  ...
  map_frame = "map",
  tracking_frame = "imu_fixed",
  published_frame = "odom_fixed",
  odom_frame = "odom_fixed",
...
TRAJECTORY_BUILDER_2D.imu_gravity_time_constant = 15.
...
----------------------------------------------------------------------
-- POSE_GRAPH（逐字段覆盖，不破坏默认 3D 相关 key）
----------------------------------------------------------------------
